                ...
                <div className="image-container">
                    ...
                    <div>
                        <div className="center flex flex-row items-end" >
                            ...
                            <h1 className='font-bold whitespace-nowrap' style={{
                            ...
                            <Grid xs={4} md={4}>
                                <div style={{ color: 'rgb(165, 124, 82)', margin: '2rem 0' }} className='font-bold'>
                                    <motion.div
                                        ...
                                        <p style={{
                                            fontSize: '16px',
                                            fontFamily: 'Gotham-Bold-Normal-ZjuVkIoU', lineHeight: '16px'
                                        }}>CONCOURSE LEVEL RETAIL <br />+ KING SUBWAY STATION</p>
                                    </motion.div>
                                    <motion.div
                                        initial={{
                                            opacity: 0,
                                        ...
                                        <p
                                            style={{
                                                fontSize: '16px', fontFamily: 'Gotham-Bold-Normal-ZjuVkIoU',
                                                lineHeight: '16px', padding: '4px'
                                            }}>PARKING LEVEL 1</p>
                    ...
                    <div className="right">
                        <div style={{ display: 'flex', flexDirection: 'column' }} className='my-9'>
                            <motion.div
                                ...
                                <h1 className='font-bold my-2' style={{
                                    color: 'rgb(165, 124, 82)',
                                    fontSize: '16px', fontFamily: 'Gotham-Bold-Normal-ZjuVkIoU', lineHeight: '16px'
                                }}>
                                    FLOOR 28&nbsp;&nbsp;&nbsp;&nbsp;LEASED
